...
public class EditarUsuarioController implements Serializable{
    ...
    @Inject
    private ListaUsuariosController listUserCon;
    ...
    @PostConstruct
    public void init(){
        setUser(listUserCon.getUsuario());
        setPersona(user.getPersona());
        setRol(user.getRol().getDescripcion());
        roles = new ArrayList<>();
    ...
    public ListaUsuariosController getListUserCon() {
        return listUserCon;
    }

    public void setListUserCon(ListaUsuariosController listUserCon) {
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + Objects.hashCode(this.usuariosEJB);
        hash = 29 * hash + Objects.hashCode(this.personasEJB);
        hash = 29 * hash + Objects.hashCode(this.rolesEJB);
        return hash;
    }
