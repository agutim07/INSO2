...
public class AlumnoEditPublicacionController implements Serializable{
    
    private Publicaciones publicacion;
    private String categoria;
    
    @Inject
    private AlumnoPublicacionesController listPubCon;
    ...
    public String editarPublicacion(){
        ...
        return "listarpublicacionesalum.xhtml";
    }
    ...
    public AlumnoPublicacionesController getListPubCon() {
        return listPubCon;
    }

    public void setListPubCon(AlumnoPublicacionesController listPubCon) {
